...
date:       2018-04-05
author:     Leosocy
header-img: img/post-bg-cmake.png
catalog: true
tags:
    - CMake
---
...
在本例中，只需要在CMakeLists.txt中加如`SET_TARGET_PROPERTIES(hello_static PROPERTIES OUTPUT_NAME "hello")`，就可以同时得到libhello.a/libhello.so两个库了。
